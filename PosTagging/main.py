...
Opciones:
    ...
    4. POS Tagging (BiLSTM Base)
    5. POS Tagging (BiLSTM Deep)
"""
...
def run_prediction(variant):
    ...
    for p in (BILSTM_DIR, BILSTM_DEEP_DIR):
        try:
            sys.path.remove(p)
        except ValueError:
            pass
...
def main():
    while True:
        ...
        print("  4. POS Tagging de oración (BiLSTM Base)")
        print("  5. POS Tagging de oración (BiLSTM Deep)")
        print("  0. Salir")
        print()
